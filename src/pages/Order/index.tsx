      ...
      contentData: [
        ...
        },
        {
          id: 2, title: 'YITO森林', list: [
            { id: 22, title: '制作中', name: "蓝玫瑰红梅气泡", count: 2, price: 20, requireType: [1], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
            { id: 23, title: '正在配送', name: "蔷薇红梅气泡", count: 2, price: 50, requireType: [1, 2, 3], description: '酸甜的草莓与清爽气泡的邂逅，配以淡淡的柠檬分子球。', src: 'http://img1.imgtn.bdimg.com/it/u=4229885950,3469296745&fm=11&gp=0.jpg', },
            { id: 24, title: '制作中', name: "蓝玫瑰红梅气泡", count: 2, price: 20, requireType: [1, 2], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
          ]
        },
        {
          id: 3, title: '水母家族', list: [
            { id: 32, title: '制作中', name: "蓝玫瑰红梅气泡2", count: 2, price: 30, requireType: [], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
            { id: 33, title: '正在配送', name: "蔷薇红梅气泡2", count: 2, price: 40, requireType: [1], description: '酸甜的草莓与清爽气泡的邂逅，配以淡淡的柠檬分子球。', src: 'http://img1.imgtn.bdimg.com/it/u=4229885950,3469296745&fm=11&gp=0.jpg', },
            { id: 34, title: '制作中', name: "蓝玫瑰红梅气泡2", count: 2, price: 35, requireType: [2], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
            { id: 35, title: '制作中', name: "蓝玫瑰红梅气泡2", count: 2, price: 30, requireType: [3], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
            { id: 36, title: '正在配送', name: "蔷薇红梅气泡2", count: 2, price: 40, requireType: [1, 3], description: '酸甜的草莓与清爽气泡的邂逅，配以淡淡的柠檬分子球。', src: 'http://img1.imgtn.bdimg.com/it/u=4229885950,3469296745&fm=11&gp=0.jpg', },
            { id: 37, title: '制作中', name: "蓝玫瑰红梅气泡2", count: 2, price: 35, requireType: [2, 3], description: '加冰+5分钟气泡', src: 'http://img1.imgtn.bdimg.com/it/u=4145206504,1491730429&fm=26&gp=0.jpg' },
          ]
        }
      ],
      requireData: [
